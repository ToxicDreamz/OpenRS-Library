...
public class AudioInstrument {
    ...
    static int[] AUDIO_SINE = new int['耀'];
    static int[] phases;
    static int[] delays;
        ...
        if (var2 < 10) {
            ...
            for (var11 = 0; var11 < var1; ++var11) {
                ...
                for (var14 = 0; var14 < 5; ++var14) {
                    if (this.oscillatorVolume[var14] != 0) {
                        ...
                        if (var15 < var1) {
                            var10000 = samples;
                            var10000[var15] += this.evaluateWave(phases[var14], var13 * volumeSteps[var14] >> 15, this.pitch.form);
                            var10000 = phases;
                            var10000[var14] += (var12 * pitchSteps[var14] >> 16) + pitchBaseSteps[var14];
                        }
                    }
                }
            }
            ...
            if (this.delayTime > 0 && this.delayDecay > 0) {
                ...
                for (var12 = var11; var12 < var1; ++var12) {
                    var10000 = samples;
                    var10000[var12] += samples[var12 - var11] * this.delayDecay / 100;
                }
            }
    ...
    final void decode(ByteBuffer var1) {
        ...
        this.duration = var1.getShort() & '\uffff';
        this.offset = var1.getShort() & '\uffff';
